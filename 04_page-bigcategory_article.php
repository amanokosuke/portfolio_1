<!--
Template Name: サービスカテゴリー記事一覧
Template Post Type: list
-->
<?php
$postId = get_the_ID();
$category_name = get_post_meta($postId, "category_name", true);
$category_content = get_post_meta($postId, "category_content", true);
			...
			<div class="category_service category_list_content">
				<div class="subcategory_list">
                    ...
                    foreach ($children1 as $child1) {
                        ?>
						<div>
							<a href="/list/<?= $post_category->slug ?>/<?= $child1->slug ?>/article/"><?= $child1->name ?></a>
						</div>
                        <?php
                    }
                    ?>
				...
				<div class="article_client_area">
					<div class="article_flame_list">
                        <?php
                        $posts = get_service_category_articles($post_category->slug);
